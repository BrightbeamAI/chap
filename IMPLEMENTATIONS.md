...
| `chap-pydantic-ai`          | Python 3.10+ | 0.2.13        | Bridge: HIL path (`review`/`decide`) | Bridge test suite passing | Beta | Apache-2.0 | Brightbeam AI |
| `chap-ag2`                  | Python 3.10+ | 0.2.13        | Bridge: HIL path (`review`/`decide`) | Bridge test suite passing | Beta | Apache-2.0 | Brightbeam AI |
| `chap-llama-index`          | Python 3.10+ | 0.2.13        | Bridge: HIL path (`review`/`decide`) | Bridge test suite passing | Beta | Apache-2.0 | Brightbeam AI |
| `chap-google-adk`           | Python 3.10+ | 0.2.13        | Bridge: HIL path (`review`/`decide`) | Bridge test suite passing | Beta | Apache-2.0 | Brightbeam AI |
